...
import xgraph.models.explainers as explainers
import xgraph.models as models
from xgraph.args import XArgs
from xgraph.data import data_args
...
def load_explainer(explainer_name: str, model: nn.Module, args: XArgs) -> explainers.GNNExplainer:
    ...
    explainer = getattr(explainers, explainer_name)(model,
