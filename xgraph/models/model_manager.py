...
import xgraph.models.models as models
from xgraph import TrainArgs, TestArgs
import torch
import sys, os
from xgraph.compatibility import compatible_state_dict
...
def config_model(model: torch.nn.Module, args, mode: str) -> None:
    ...
    if mode == 'test' or mode == 'explain':
        try:
            ...
            exit(1)
        state_dict = compatible_state_dict(ckpt['state_dict'])
