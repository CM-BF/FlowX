...
from xgraph import common_args, train_args, test_args, x_args, TrainArgs, data_args
...
class Metric(object):
    ...
    set2task = {"ESOL": "reg-l1", "FreeSolv": "reg-l1", "Lipo": "reg-l1",
                ...
                "ba_lrp": "bcs", "ba_infe": "bcs", "ba_shapes": "mcs", "graph_sst2": "bcs"}
    ...
    set2score_name = {"ESOL": "rmse", "FreeSolv": "rmse", "Lipo": "rmse",
                      ...
                      "ba_lrp": "accuracy", "ba_infe": "accuracy", "ba_shapes": "accuracy", "graph_sst2": "accuracy"}
