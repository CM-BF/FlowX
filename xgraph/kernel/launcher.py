...
# args_group = [f'-m xgraph.kernel.pipeline --task {task} --model_name {model_dataset[0]} --dataset_name {model_dataset[1]} ' \
#               f'--target_idx {model_dataset[2]} --explainer {explainer} --sparsity {sparsity} ' \
#               f'--log_file {task}_{model_dataset[1]}_{model_dataset[0]}_{explainer}_{sparsity}.log' \
...
# task = 'test'
#
# args_group = [f'-m xgraph.kernel.pipeline --task {task} --model_name {model[0]} --dataset_name {dataset[0]} ' \
